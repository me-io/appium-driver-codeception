 ...
 trait AppiumCommands 
{
	...
	**/
	public function startRecordingScreen($data){
			return $this->driverCommand(Constants::$POST, Constants::$START_RECORDING_SCREEN, $data);
	}
	/**
	* stopRecordingScreen
	*
	...
	**/
	public function stopRecordingScreen(){
			return $this->driverCommand(Constants::$POST, Constants::$STOP_RECORDING_SCREEN);
	}
	/**
	...
	**/
	public function getPerformanceDataTypes(){
			return $this->driverCommand(Constants::$POST, Constants::$TYPES_PERFORMANCEDATA);
	}
	/**
	* getPerformanceData
	*
	...
	**/
	public function getPerformanceData($data){
			return $this->driverCommand(Constants::$POST, Constants::$GETPERFORMANCEDATA, $data);
	}
	/**
	* pressKeyCode
	*
	...
	**/
	public function sendSMS($data){
			return $this->driverCommand(Constants::$POST, Constants::$SEND_SMS, $data);
	}
	/**
	* gsmCall
	*
	...
	**/
	public function gsmCall($data){
			return $this->driverCommand(Constants::$POST, Constants::$GSM_CALL, $data);
	}
	/**
	* gsmSignal
	*
	...
	**/
	public function gsmSignal($data){
			return $this->driverCommand(Constants::$POST, Constants::$GSM_SIGNAL, $data);
	}
	/**
	* gsmVoice
	*
	...
	**/
	public function gsmVoice($data){
			return $this->driverCommand(Constants::$POST, Constants::$GSM_VOICE, $data);
	}
	/**
	* powerCapacity
	*
	...
	**/
	public function powerCapacity($data){
			return $this->driverCommand(Constants::$POST, Constants::$POWER_CAPACITY, $data);
	}
	/**
	* powerAC
	*
	...
	**/
	public function powerAC($data){
			return $this->driverCommand(Constants::$POST, Constants::$POWER_AC, $data);
	}
	/**
	* networkSpeed
	*
	...
	**/
	public function networkSpeed($data){
			return $this->driverCommand(Constants::$POST, Constants::$NETWORK_SPEED, $data);
	}
	/**
	* keyevent
	*
	...
	**/
	public function getCurrentPackage(){
			return $this->driverCommand(Constants::$GET, Constants::$CURRENT_PACKAGE);
	}
	/**
	* installApp
	*
	...
	**/
	public function toggleEnrollTouchId($data){
			return $this->driverCommand(Constants::$POST, Constants::$TOGGLE_TOUCH_ID_ENROLLMENT, $data);
	}
	/**
	* launchApp
	*
	...
	**/
	public function getAlertText(){
			return $this->driverCommand(Constants::$GET, Constants::$ALERT_TEXT);
	}
	/**
	* setAlertText
	*
	...
	**/
	public function setAlertText($data){
			return $this->driverCommand(Constants::$POST, Constants::$ALERT_TEXT, $data);
	}
	/**
	* postAcceptAlert
	*
	...
	**/
	public function postAcceptAlert(){
			return $this->driverCommand(Constants::$POST, Constants::$ACCEPT_ALERT);
	}
	/**
	* postDismissAlert
	*
	...
	**/
	public function postDismissAlert(){
			return $this->driverCommand(Constants::$POST, Constants::$DISMISS_ALERT);
	}
	/**
	* getElementRect
	*
